...
<link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@100;200;300;500&display=swap" rel="stylesheet">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <br>
        <div class="alert alert-success">Your birthday wish as been received. It would be reflected at
<a href="http://happy60thbirthdayprofessortorimiro.xyz/">http://happy60thbirthdayprofessortorimiro.xyz/</a> soonest. 
<hr>
Cheers!🥂</div>
        </div>
    </body>
